    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="page-header">
                ...
                <a href="{{ URL('admin/brands/create') }}" class="btn btn-primary" id="sample_editable_1_new" style="float: right;">@lang('main.add_new')
                                        ...
                                        @foreach($brands as $key => $brand)
                                            <tr class="delete_{{$brand->id}}">
                                                ...
                                                <td class="@if(Lang::locale() == 'ar') text-left @else text-right @endif">
                                                    <a class="btn btn-primary" href="{{URL('admin/brands/' . $brand->id)}}" style="padding: 5px 10px;">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <a class="btn btn-success" href="{{URL('admin/brands/' . $brand->id . '/edit')}}" style="padding: 5px 10px;">
